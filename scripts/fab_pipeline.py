...
DEFAULT_UE_ROOT = Path(r"C:\Program Files\Epic Games\UE_5.0")
...
def create_project(args: argparse.Namespace) -> None:
    ...
    project_data["EngineAssociation"] = "5.0"
...
def validate_project(args: argparse.Namespace) -> None:
    ...
    if engine != "5.0":
        raise SystemExit(f"Expected EngineAssociation 5.0, got {engine!r}")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ue = sub.add_parser("ue-command", help="Print the UE 5.0.3 command for in-editor automation.")
