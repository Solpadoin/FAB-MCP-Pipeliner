...
Infrastructure for building repeatable Unreal Engine 5.0.3 FAB asset-pack projects from generated image sets.
...
- `scripts/ue_fab_pipeline.py` - Unreal Python script executed inside UE 5.0.3 for plugin toggles, texture reimport, redirector cleanup, map loading, screenshot capture, and saves.
